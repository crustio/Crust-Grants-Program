...
Please provide the following:
  * Opennetwork
  * Most of people use centralized video sharing platforms and they are satisfied with that, but up to one day they realized that they are hardly controlled by incognito algorithms and decisions of the management board behind these platforms. It's easy to realize how powerful the centralized platforms are from the recent political events in 2020. Opennetwork was created as an open-source video sharing platform based on distributed networks to offer a solution opposed to conventional platforms:
