...
|Content storage and delivery| [SkyeKiwi Protocol](http://skye.kiwi/), [CruDrive](https://github.com/crudrive), [Socbay](http://socbay.io), [CruTransfer](https://crutransfer.me/#/home), [Box](https://github.com/crustio/Crust-Grants-Program/blob/main/applications/box.md)   | Accelerated and secured P2P-CDNs; Cloud storage platform based on Crust|
